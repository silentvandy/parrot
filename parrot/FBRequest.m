...
- (void)startRequest {
    ...
    // 设置请求类型
    if (self.requestType) {
        self.manager.requestSerializer = [FBRequest requestSerializerWith:self.requestType];
    } else {
        self.manager.requestSerializer = [FBRequest requestSerializerWith:HTTPRequestType];
    }
    ...
    if (self.responseType) {
        self.manager.responseSerializer = [FBRequest responseSerializerWith:self.responseType];
        ...
        self.manager.responseSerializer = [FBRequest responseSerializerWith:HTTPResponseType];
        self.manager.responseSerializer.acceptableContentTypes = \
        [self.manager.responseSerializer.acceptableContentTypes setByAddingObject:@"text/html"];
    }
...
+ (instancetype)requestWithUrlString:(NSString *)urlString
    ...
    FBRequest *request        = [[[self class] alloc] init];
